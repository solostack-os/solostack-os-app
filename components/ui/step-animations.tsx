...
export function StepOneAnimation() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#0d1526", border: "1px solid rgba(108,140,255,0.25)", boxShadow: "0 0 16px rgba(108,140,255,0.10), 0 4px 20px rgba(0,0,0,0.22)", height: CARD_HEIGHT }}
    >
      {/* Mini top bar */}
      <div
