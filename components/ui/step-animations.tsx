...
export function StepOneAnimation() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#0d1526", border: "1px solid rgba(108,140,255,0.25)", boxShadow: "0 0 24px rgba(108,140,255,0.20), 0 0 48px rgba(108,140,255,0.10), inset 0 0 0 1px rgba(108,140,255,0.08)", height: CARD_HEIGHT }}
    >
      {/* Mini top bar */}
      <div
